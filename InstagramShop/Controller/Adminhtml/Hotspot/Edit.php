...
class Edit extends \Magenest\InstagramShop\Controller\Adminhtml\Hotspot
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('current_hotspot', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Hotspot'));
        return $resultPage;
    }
}
