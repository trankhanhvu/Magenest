...
define([
    ...
    return Collection.extend({
        defaults: {
            template: 'Magenest_Movie/listingnew',
        ...
        getTotal: function () {
            ...
            this.rows.forEach(function (item) {
                let subtotal = Number(item['subtotal'].replace(/[^0-9.-]+/g, ""));
                self.total = self.total + parseFloat(subtotal);
            })
            ...
            return 'Total : ' + formatter.format(self.total);
        },
